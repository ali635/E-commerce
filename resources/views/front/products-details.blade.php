                                            ...
                                            {{-- <form action="{{route('products.reviews.store',$product -> id )}}"
                                                ...
                                                <div class="productdetail-right col-12 col-lg-6 col-md-6">
                                                    ...
                                                    <div class="in_border end">
                                                        ...
                                                        <div class="sku">
                                                            <label class="control-label">{{ __('site/site.sku') }}:</label>
                                                            <span itemprop="sku"
                                                                  content="demo_1">{{$product -> sku ?? '--'}}</span>
                                                        </div>
                                                        <div class="pro-cate">
                                                            <label class="control-label">{{ __('site/site.categories') }}:</label>
                                                ...
                                                <div class="productdetail-left col-12 col-lg-6 col-md-6">
                                                    ...
                                                    <div class="product-quantity">
                                                        <span class="control-label">{{ __('site/site.Quantity') }} : </span>
                                                        <div class="qty">
