                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> {{ __('admin/sidebar.main_sections') }} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ __('admin/sidebar.edit') }} {{ __('admin/sidebar.main_sections') }} </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src=""
                                                        class="rounded-circle  height-150" alt="{{ __('admin/sidebar.dep_image') }}  ">
                                                </div>
                                            </div>
