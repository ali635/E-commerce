...
@section('title','تعديل | العلامات التجارية')
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ __('admin/sidebar.edit') }} {{ __('admin/sidebar.brands') }} </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$brand  -> photo}}"
                                                        class="rounded-circle  height-250" alt="{{ __('admin/sidebar.img_brands') }}">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label>{{ __('admin/sidebar.img_brands') }} </label>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{ __('admin/sidebar.brands_dep') }} </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
