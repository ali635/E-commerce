...
@section('title','انشاء صور |  المنتج')
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{ __('admin/sidebar.add_product_img') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{ __('admin/sidebar.product_img') }} </h4>
